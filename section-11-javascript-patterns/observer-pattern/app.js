...
EventObserver.prototype = {
    ...
    unsubscribe: function (fn) {
        this.observers = this.observers.filter(function (item) {
            // filter out from the list whatever matches the callback function. if there is no match, the callback gets to say on the list. the filter returns a new list and reassigns the list of observers.
            if (item !== fn) {
                return item;
            }
        });
