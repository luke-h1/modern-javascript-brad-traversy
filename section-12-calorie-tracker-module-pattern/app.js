...
const ItemCtrl = (function () {
  ...
  return {
    ...
    getItemById: function (id) {
      let found = null;
      data.items.forEach((item) => {
        // loop thru items and set found to the item that is clicked
        if (item.id === id) {
          // if item.id is eq to id passed in set found = to the item; & return it
          found = item;
        }
      });
      return found;
